...
# We will be using the subprocess module to run commands on Linux.
import subprocess
...
if not 'SUDO_UID' in os.environ.keys():
    print("Try running this program with sudo (Programı çalıştırmak için lütfen yönetici izini verin).")
    exit()
...
if len(check_wifi_result) == 0:
    print("Please connect a WiFi controller and try again(Lütfen harici wifi kartı takın ve tekrar deneyin).")
    exit()

# Menu to select WiFi interface from
print("The following WiFi interfaces are available  (Aşağıdaki WiFi arayüzleri mevcuttur ,NOT:Lütfen kendi agınızdan dısında bu programı çalıstırmayın ve wifi yakın olmalıdır... ,bu program egitim amaçlıdır yasa dısı faliyetlere katılanlardan hiç bir şekilde kabul etmiyorum)):")
...
while True:
    ...
    try:
        ...
        print("Please enter a number that corresponds with the choices.   (Lütfen seçeneklere karşılık gelen bir sayı girin.)")
...
print("Putting Wifi adapter into monitored mode:  (Wifi adaptörünüzü monitor moduna alııyorum ;))")
...
while True:
    ...
    try:
        ...
        print("Please try again.(Lütfen tekrar deneyin)")
...
try:
    ...
    print("Thank you! Exiting now   Yine Bekleriz ;)    .....")
